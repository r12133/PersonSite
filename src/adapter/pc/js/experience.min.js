function experience(){
    ...
    var base_path_img = '/static/img/';
    var base_path_audio = '/static/audio/';
    // 全局控制器
    var control = {
        t: 0,
        autoplay: true,
    ...
    function winScroll() {
        ...
        if(st >= ( 13 * win_h + 200 ) && st <= ( 13 * win_h + 200 + 192 + 30 ) ) {
            ...
            (function(){
                ...
                img.src = base_path_img + will_index + '.jpg';
        ...
        if(st >= ( 25.3 * win_h + 200 + 192 + 30 ) && st < ( 27 * win_h + 200 + 192 + 30 ) ) {
            ...
            (function(){
                ...
                if(op == 0) {
                    // page_eightteen.style.backgroundImage = "url(" + base_path_img + "bg(16_2).jpg)";
                    page_eightteen.style.opacity = 0.4;
                    page_eightteen.classList.remove('lightOn');
                }
                
                if(op >= 2) {
                    page_eightteen.style.opacity = op * 2 / 10;
                    // page_eightteen.style.backgroundImage = "url(" + base_path_img + "bg(16).jpg)";
                    page_eightteen.classList.add('lightOn');
                }
    ...
    function globalAudioSettings(st){
        ...
        if(st >= ( .3 * win_h ) && st <= ( 1.8 * win_h ) ) {
            checkAndPlay(base_path_audio + '/bg_start.ogg',true,true);
        }
        // 踹门
        if(st >= ( 1.3 * win_h ) && st <= ( 1.8 * win_h ) ) {
            checkAndPlay(base_path_audio + '/kick_door.ogg');
        }
        // 小高潮
        if(st >= ( 3.2 * win_h )) {
            checkAndPlay(base_path_audio + '/bg_high.ogg',true,true);
        }
        // 破窗
        if(st >= ( 3.5 * win_h ) && st <= ( 4 * win_h ) ) {
            checkAndPlay(base_path_audio + '/verre.ogg');
        }
        // 猎犬
        if(st >= ( 5.5 * win_h ) && st <= ( 6 * win_h ) ) {
            checkAndPlay(base_path_audio + '/dogs.ogg');
        }
        // 猎犬2
        if(st >= ( 7.5 * win_h ) && st <= ( 8 * win_h ) ) {
            checkAndPlay(base_path_audio + '/dogs_chase.ogg');
        }
        // 车鸣
        if(st >= ( 10.5 * win_h ) && st <= ( 11 * win_h ) ) {
            checkAndPlay(base_path_audio + '/car_drive_far.ogg');
        }
        // 车鸣2
        if(st >= ( 11.8 * win_h ) && st <= ( 13 * win_h ) ) {
            checkAndPlay(base_path_audio + '/car_drive_close.ogg');
        }
        // battle
        if(st >= ( 13 * win_h + 100 ) && st <= ( 13 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/battle.ogg');
        }
        // 滑落
        if(st >= ( 14.5 * win_h + 422 ) && st <= ( 15.5 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/slide_down.ogg');
        }
        // 追踪
        if(st >= ( 17.5 * win_h + 422 ) && st <= ( 18.5 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/bg_flying.ogg',true, true);
        }
        // 潜入
        if(st >= ( 21.7 * win_h + 422 ) && st <= ( 22.5 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/enter.ogg');
        }
        // 开灯
        if(st >= ( 25.5 * win_h + 422 ) && st <= ( 26 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/light_on.ogg');
        }
        // 结束音乐
        if(st >= ( 26 * win_h + 422 ) ) {
            checkAndPlay(base_path_audio + '/bg_end.ogg',true, true);
        }
    }

    // window.onload = function(){
        var loading = document.querySelector('.parrlex .loading');
        setTimeout(function(){
